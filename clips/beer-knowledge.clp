...
(defrule determine-best-beer-attributes-if-which-age-is-18-23
   ...
   (which-age 18-23)
   =>
   (assert (attribute (name best-alcohol) (value mild) (certainty .05)))
   (assert (attribute (name best-alcohol) (value not-detectable) (certainty .04)))
   (assert (attribute (name best-flavor) (value crisp-clean) (certainty .05)))
   (assert (attribute (name best-flavor) (value fruity-spicy) (certainty .04)))
   (assert (attribute (name explanation-scenario) (value (str-cat "At a younger age the palate is usually eased in with "
           "approachable, low-alcohol styles with a clean or lightly fruity flavour, rather than intense or very bitter ones.")))))

(defrule determine-best-beer-attributes-if-which-age-is-24-29
   (declare (salience ?*medium-low-priority*))
   (which-age 24-29)
   =>
   (assert (attribute (name best-alcohol) (value noticeable) (certainty .03)))
   (assert (attribute (name best-alcohol) (value mild) (certainty .03)))
   (assert (attribute (name explanation-scenario) (value (str-cat "Your age lets me choose from a broad variety of beers, "
           "balanced across strength and flavour.")))))

(defrule determine-best-beer-attributes-if-which-age-is-more-or-equal-than-30
   (declare (salience ?*medium-low-priority*))
   (which-age >=30)
   =>
   (assert (attribute (name best-flavor) (value dark-roasty) (certainty .03)))
   (assert (attribute (name best-flavor) (value hoppy-bitter) (certainty .03)))
   (assert (attribute (name best-flavor) (value sour-tart-funky) (certainty .03)))
   (assert (attribute (name best-alcohol) (value harsh) (certainty .04)))
   (assert (attribute (name best-alcohol) (value noticeable) (certainty .05)))
   (assert (attribute (name explanation-scenario) (value (str-cat "A more experienced palate tends to enjoy complex, "
           "assertive styles, so I can suggest something bolder and more peculiar.")))))

(defrule determine-best-beer-attributes-if-which-season-is-autumn
   (declare (salience ?*medium-low-priority*))
   (which-season autumn)
   =>
   (assert (attribute (name best-color) (value amber) (certainty .05)))
   ...
   (assert (attribute (name best-flavor) (value fruity-spicy) (certainty .04)))
   (assert (attribute (name explanation-scenario) (value (str-cat "Autumn is the season of malty amber beers of moderate "
           "strength: Marzen and Oktoberfest lagers, spiced pumpkin ales and nutty brown ales.")))))

(defrule determine-best-beer-attributes-if-which-season-is-spring
   (declare (salience ?*medium-low-priority*))
   (which-season spring)
   =>
   (assert (attribute (name best-color) (value pale) (certainty .04)))
   (assert (attribute (name best-color) (value amber) (certainty .03)))
   (assert (attribute (name best-alcohol) (value mild) (certainty .05)))
   (assert (attribute (name best-alcohol) (value not-detectable) (certainty .04)))
   (assert (attribute (name best-flavor) (value fruity-spicy) (certainty .05)))
   (assert (attribute (name best-flavor) (value crisp-clean) (certainty .04)))
   (assert (attribute (name explanation-scenario) (value (str-cat "Spring calls for fresh, moderately strong beers with a "
           "clean or lightly spicy, floral character, such as saisons, Maibocks and pale ales.")))))
...
(defrule determine-best-beer-attributes-if-which-season-is-summer
   ...
   (assert (attribute (name best-flavor) (value crisp-clean) (certainty .05)))
   (assert (attribute (name best-flavor) (value fruity-spicy) (certainty .04)))
   (assert (attribute (name best-carbonation) (value high) (certainty .03)))
   (assert (attribute (name explanation-scenario) (value (str-cat "Hot days call for light, refreshing and very drinkable "
           "beers: low in alcohol, crisp and pale, such as pilsners, wheat beers and session ales.")))))
...
(defrule determine-best-beer-attributes-if-which-season-is-winter
   ...
   (assert (attribute (name explanation-scenario) (value (str-cat "Frosty days are perfect for warming, full-bodied beers: "
           "strong, dark and malty or roasty, such as stouts, bocks and barley wines.")))))

(defrule determine-best-beer-attributes-if-he-is-not-a-regular-beer-drinker
   (declare (salience ?*medium-low-priority*))
   (regular-beer-drinker no)
   =>
   (assert (attribute (name best-flavor) (value crisp-clean) (certainty .08)))
   (assert (attribute (name best-flavor) (value hoppy-bitter) (certainty -.05)))
   (assert (attribute (name best-alcohol) (value not-detectable) (certainty .04)))
   (assert (attribute (name explanation-scenario) (value (str-cat "Since you're not a regular beer drinker, I'll start you "
           "on approachable, clean and easy-drinking styles, low in bitterness and alcohol; later you'll be ready for something more peculiar.")))))

(defrule determine-best-beer-attributes-if-he-is-going-to-smoke
   (declare (salience ?*medium-low-priority*))
   (smoker yes)
   =>
   (assert (attribute (name best-flavor) (value dark-roasty) (certainty .06)))
   (assert (attribute (name best-flavor) (value malty-sweet) (certainty .05)))
   (assert (attribute (name best-color) (value dark) (certainty .04)))
   (assert (attribute (name best-alcohol) (value noticeable) (certainty .05)))
   (assert (attribute (name explanation-scenario) (value (str-cat "Tobacco dulls the palate and stands up to bold beers, so "
           "robust full-flavoured styles pair best while smoking: roasty, malty and stronger beers such as porters, stouts and smoked beers.")))))
...
(defrule preferred-color-is-pale
   ...
   =>
   (assert (attribute (name best-color) (value pale) (certainty .2)))
   (assert (attribute (name best-color) (value brown) (certainty -.1)))
   (assert (attribute (name best-color) (value dark) (certainty -.2)))
...
(defrule preferred-color-is-amber
   ...
   =>
   (assert (attribute (name best-color) (value amber) (certainty .2)))
   (assert (attribute (name best-color) (value dark) (certainty -.1)))
...
(defrule preferred-color-is-brown
   ...
   =>
   (assert (attribute (name best-color) (value brown) (certainty .2)))
   (assert (attribute (name best-color) (value pale) (certainty -.1)))
...
(defrule preferred-color-is-dark
   ...
   =>
   (assert (attribute (name best-color) (value dark) (certainty .2)))
   (assert (attribute (name best-color) (value amber) (certainty -.1)))
   (assert (attribute (name best-color) (value pale) (certainty -.2)))
...
(defrule preferred-alcohol-is-low
   ...
   =>
   (assert (attribute (name best-alcohol) (value not-detectable) (certainty .2)))
   (assert (attribute (name best-alcohol) (value noticeable) (certainty -.1)))
   (assert (attribute (name best-alcohol) (value harsh) (certainty -.2)))
...
(defrule preferred-alcohol-is-mild
   ...
   =>
   (assert (attribute (name best-alcohol) (value mild) (certainty .2)))
   (assert (attribute (name best-alcohol) (value harsh) (certainty -.1)))
...
(defrule preferred-alcohol-is-high
   ...
   =>
   (assert (attribute (name best-alcohol) (value noticeable) (certainty .2)))
   (assert (attribute (name best-alcohol) (value not-detectable) (certainty -.1)))
...
(defrule preferred-alcohol-is-very-high
   ...
   =>
   (assert (attribute (name best-alcohol) (value harsh) (certainty .2)))
   (assert (attribute (name best-alcohol) (value mild) (certainty -.1)))
   (assert (attribute (name best-alcohol) (value not-detectable) (certainty -.2)))
...
(defrule preferred-carbonation-is-low
   ...
   =>
   (assert (attribute (name best-carbonation) (value low) (certainty .2)))
   (assert (attribute (name best-carbonation) (value high) (certainty -.2)))
...
(defrule preferred-carbonation-is-medium
   ...
   =>
   (assert (attribute (name best-carbonation) (value medium) (certainty .2)))
...
(defrule preferred-flavor-is-clean
   ...
   =>
   (assert (attribute (name best-flavor) (value crisp-clean) (certainty .2)))
...
(defrule preferred-flavor-is-sweet
   ...
   =>
   (assert (attribute (name best-flavor) (value malty-sweet) (certainty .2)))
   (assert (attribute (name best-flavor) (value hoppy-bitter) (certainty -.2)))
...
(defrule preferred-flavor-is-roasty
   ...
   =>
   (assert (attribute (name best-flavor) (value dark-roasty) (certainty .2)))
   (assert (attribute (name best-flavor) (value fruity-spicy) (certainty -.2)))
...
(defrule preferred-flavor-is-sour
   ...
   =>
   (assert (attribute (name best-flavor) (value sour-tart-funky) (certainty .2)))
...
(defrule determine-best-beer-attributes-if-which-cheese-style-is-fresh
   ...
   =>
   (assert (attribute (name best-style) (value "Wheat Beer") (certainty .8)))
   (assert (attribute (name best-name) (value "Belgian-Style Fruit Lambic") (certainty .8)))
   (assert (attribute (name best-name) (value "Belgian-Style Lambic/Gueuze") (certainty .8)))
...
(defrule determine-best-beer-attributes-if-which-fresh-cheese-is-Mascarpone
   ...
   =>
   (assert (attribute (name best-name) (value "Belgian-Style Witbier") (certainty .9))))

(defrule determine-best-beer-attributes-if-which-fresh-cheese-is-Chevre
   (declare (salience ?*medium-low-priority*))
   (which-fresh-cheese Chèvre)
   =>
   (assert (attribute (name best-name) (value "American Wheat") (certainty .9)))
   (assert (attribute (name best-name) (value "German-Style Hefeweizen") (certainty .9)))
   (assert (attribute (name best-name) (value "Belgian-Style Fruit Lambic") (certainty .9)))
   (assert (attribute (name best-name) (value "European-Style Export") (certainty .9))))
...
(defrule determine-best-beer-attributes-if-which-fresh-cheese-is-Feta-or-which-pork-is-loin
   ...
   (or (which-fresh-cheese Feta)
       (which-pork loin))
   =>
   (assert (attribute (name best-name) (value "California Common") (certainty .9))))

(defrule determine-best-beer-attributes-if-which-fresh-cheese-is-Cream-Cheese
   (declare (salience ?*medium-low-priority*))
   (which-fresh-cheese "Cream Cheese")
   =>
   (assert (attribute (name best-name) (value "Fruit and Field Beer") (certainty .9))))

(defrule determine-best-beer-attributes-if-which-cheese-style-is-semi-soft
   (declare (salience ?*medium-low-priority*))
   (which-cheese-style semi-soft)
   =>
   (assert (attribute (name best-style) (value "Pale Ale") (certainty .8)))
   (assert (attribute (name best-name) (value "German-Style Bock") (certainty .8)))
   (assert (attribute (name best-name) (value "German-Style Kölsch") (certainty .8)))
...
(defrule determine-best-beer-attributes-if-which-semi-soft-cheese-is-Mozzarella
   ...
   =>
   (assert (attribute (name best-flavor) (value crisp-clean) (certainty .5)))
   (assert (attribute (name best-name) (value "American Imperial Red Ale") (certainty .9))))

(defrule determine-best-beer-attributes-if-which-semi-soft-cheese-is-Colby
   (declare (salience ?*medium-low-priority*))
   (which-semi-soft-cheese Colby)
   =>
   (assert (attribute (name best-name) (value "German-Style Helles") (certainty .9))))

(defrule determine-best-beer-attributes-if-which-semi-soft-cheese-is-Havarti
   (declare (salience ?*medium-low-priority*))
   (which-semi-soft-cheese Havarti)
   =>
   (assert (attribute (name best-name) (value "Berliner-Style Weisse") (certainty .9))))
...
(defrule determine-best-beer-attributes-if-which-semi-soft-cheese-is-Monterey-Jack-or-shellfish-is-mild
   ...
   =>
   (assert (attribute (name best-name) (value "American Cream Ale") (certainty .9))))

(defrule determine-best-beer-attributes-if-which-cheese-style-is-firm-hard
   (declare (salience ?*medium-low-priority*))
   (which-cheese-style firm/hard)
   =>
   (assert (attribute (name best-style) (value "Bock") (certainty .8)))
   (assert (attribute (name best-style) (value "Brown Ale") (certainty .8)))
   (assert (attribute (name best-name) (value "Bohemian-Style Pilsener") (certainty .8)))
   (assert (attribute (name best-name) (value "German-Style Pilsener") (certainty .8)))
   (assert (attribute (name best-name) (value "American Imperial Stout") (certainty .8)))
...
(defrule determine-best-beer-attributes-if-which-firm-hard-cheese-is-Swiss
   ...
   =>
   (assert (attribute (name best-name) (value "German-Style Maibock") (certainty .9))))
...
(defrule determine-best-beer-attributes-if-which-firm-hard-cheese-is-Gouda
   ...
   (assert (attribute (name best-flavor) (value malty-sweet) (certainty .5)))
   (assert (attribute (name best-flavor) (value hoppy-bitter) (certainty -.5)))
   (assert (attribute (name best-name) (value "German-Style Dunkelweizen") (certainty .9))))

(defrule determine-best-beer-attributes-if-which-type-of-Gouda-is-aged
   (declare (salience ?*medium-low-priority*))
   (which-type-of-Gouda aged)
   =>
   (assert (attribute (name best-name) (value "American Brown Ale") (certainty .9)))
   (assert (attribute (name best-name) (value "English-Style Brown Ale") (certainty .9)))
   (assert (attribute (name best-name) (value "Belgian-Style Quadrupel") (certainty .9)))
   (assert (attribute (name best-name) (value "Baltic-Style Porter") (certainty .9)))
   (assert (attribute (name best-name) (value "American Black Ale") (certainty .9))))

(defrule determine-best-beer-attributes-if-which-type-of-Gouda-is-smoked
   (declare (salience ?*medium-low-priority*))
   (which-type-of-Gouda smoked)
   =>
   (assert (attribute (name best-name) (value "American Imperial Porter") (certainty .9))))

(defrule determine-best-beer-attributes-if-which-firm-hard-cheese-is-Cheddar
   (declare (salience ?*medium-low-priority*))
   (which-firm/hard-cheese Cheddar)
   =>
   (assert (attribute (name best-name) (value "Irish-Style Red") (certainty .9))))

(defrule determine-best-beer-attributes-if-which-color-of-Cheddar-is-white
   (declare (salience ?*medium-low-priority*))
   (which-color-of-Cheddar white)
   =>
   (assert (attribute (name best-name) (value "American Amber Lager") (certainty .9)))
   (assert (attribute (name best-name) (value "German-Style Pilsener") (certainty .9))))

(defrule determine-best-beer-attributes-if-which-Cheddar-seasoning-is-mild
   (declare (salience ?*medium-low-priority*))
   (which-Cheddar-seasoning mild)
   =>
   (assert (attribute (name best-name) (value "American Pale Ale") (certainty .9)))
   (assert (attribute (name best-name) (value "English-Style Mild") (certainty .9))))

(defrule determine-best-beer-attributes-if-which-Cheddar-seasoning-is-medium
   (declare (salience ?*medium-low-priority*))
   (which-Cheddar-seasoning medium)
   =>
   (assert (attribute (name best-name) (value "American Amber Ale") (certainty .9)))
   (assert (attribute (name best-name) (value "American Pale Ale") (certainty .9))))
...
(defrule determine-best-beer-attributes-if-which-Cheddar-seasoning-is-aged
   ...
   (assert (attribute (name best-flavor) (value hoppy-bitter) (certainty .5)))
   (assert (attribute (name best-flavor) (value malty-sweet) (certainty -.5)))
   (assert (attribute (name best-name) (value "English-Style IPA") (certainty .9)))
   (assert (attribute (name best-name) (value "English-Style Oatmeal Stout") (certainty .9))))
...
(defrule determine-best-beer-attributes-if-Cheddar-is-sharp-or-which-rich-is-grilled-lamb
   ...
   (or (Cheddar-is-sharp yes)
       (and (meat-cooking-method grilled)
            (which-rich lamb)))
   =>
   (assert (attribute (name best-name) (value "American Stout") (certainty .9))))
...
(defrule determine-best-beer-attributes-if-which-color-of-Cheddar-is-white-and-which-Cheddar-seasoning-is-mild
   ...
   (which-Cheddar-seasoning mild)
   =>
   (assert (attribute (name best-name) (value "Bohemian-Style Pilsener") (certainty .9))))

(defrule determine-best-beer-attributes-if-which-type-of-Swiss-is-Emmental
   (declare (salience ?*medium-low-priority*))
   (which-type-of-Swiss Emmental)
   =>
   (assert (attribute (name best-name) (value "German-Style Brown/Altbier") (certainty .9))))

(defrule determine-best-beer-attributes-if-which-type-of-Swiss-is-Gruyere
   (declare (salience ?*medium-low-priority*))
   (which-type-of-Swiss Gruyère)
   =>
   (assert (attribute (name best-name) (value "English-Style Brown Porter") (certainty .9)))
   (assert (attribute (name best-name) (value "Robust Porter") (certainty .9))))

(defrule determine-best-beer-attributes-if-Swiss-is-aged
   (declare (salience ?*medium-low-priority*))
   (Swiss-is-aged yes)
   =>
   (assert (attribute (name best-name) (value "German-Style Bock") (certainty .9))))

(defrule determine-best-beer-attributes-if-which-firm-hard-cheese-is-Parmesan
   (declare (salience ?*medium-low-priority*))
   (which-firm/hard-cheese Parmesan)
   =>
   (assert (attribute (name best-name) (value "American Imperial Stout") (certainty .9))))
...
(defrule determine-best-beer-attributes-if-which-cheese-style-is-blue
   ...
   (assert (attribute (name best-flavor) (value dark-roasty) (certainty .5)))
   (assert (attribute (name best-flavor) (value fruity-spicy) (certainty -.5)))
   (assert (attribute (name best-style) (value "India Pale Ale") (certainty .8)))
   (assert (attribute (name best-name) (value "American Black Ale") (certainty .8)))
...
(defrule determine-best-beer-attributes-if-which-blue-or-natural-rind-cheese-is-Stilton
   ...
   =>
   (assert (attribute (name best-name) (value "British-Style Barley Wine Ale") (certainty .9))))
...
(defrule determine-best-beer-attributes-if-which-cheese-style-is-natural-rind
   ...
   =>
   (assert (attribute (name best-style) (value "Pale Ale") (certainty .8)))
   (assert (attribute (name best-name) (value "Belgian-Style Golden Strong Ale") (certainty .8)))
   (assert (attribute (name best-name) (value "Belgian-Style Blonde Ale") (certainty .8)))
   (assert (attribute (name best-name) (value "Blonde Ale") (certainty .8)))
   (assert (attribute (name best-name) (value "American Barley Wine") (certainty .8)))
   (assert (attribute (name best-name) (value "British-Style Barley Wine Ale") (certainty .8)))
...
(defrule determine-best-beer-attributes-if-which-natural-rind-cheese-is-Brie
   ...
   (assert (attribute (name best-flavor) (value fruity-spicy) (certainty .5)))
   (assert (attribute (name best-flavor) (value dark-roasty) (certainty -.5)))
   (assert (attribute (name best-name) (value "Belgian-Style Blonde Ale") (certainty .9)))
   (assert (attribute (name best-name) (value "Belgian-Style Saison") (certainty .9))))

(defrule determine-best-beer-attributes-if-which-natural-rind-cheese-is-Camembert
   (declare (salience ?*medium-low-priority*))
   (which-natural-rind-cheese Camembert)
   =>
   (assert (attribute (name best-name) (value "Pumpkin Beer") (certainty .9))))
...
(defrule determine-best-beer-attributes-if-which-natural-rind-cheese-is-Triple-Creme
   ...
   =>
   (assert (attribute (name best-name) (value "Belgian-Style Golden Strong Ale") (certainty .9)))
   (assert (attribute (name best-name) (value "Belgian-Style Tripel") (certainty .9))))

(defrule determine-best-beer-attributes-if-which-natural-rind-cheese-is-Mimolette
   (declare (salience ?*medium-low-priority*))
   (which-natural-rind-cheese Mimolette)
   =>
   (assert (attribute (name best-name) (value "Belgian-Style Flanders") (certainty .9))))
...
(defrule determine-best-beer-attributes-if-which-cheese-style-is-washed-rind
   ...
   (assert (attribute (name best-name) (value "Belgian-Style Blonde Ale") (certainty .8)))
   (assert (attribute (name best-name) (value "Belgian-Style Golden Strong Ale") (certainty .8)))
   (assert (attribute (name best-name) (value "Belgian-Style Pale Ale") (certainty .8)))
   (assert (attribute (name best-name) (value "Belgian-Style Dubbel") (certainty .8)))
   (assert (attribute (name best-name) (value "French-Style Biére de Garde") (certainty .8)))
...
(defrule determine-best-beer-attributes-if-which-washed-rind-cheese-is-Taleggio
   ...
   =>
   (assert (attribute (name best-name) (value "Belgian-Style Pale Ale") (certainty .9))))
...
(defrule determine-best-beer-attributes-if-which-entree-is-legumes
   ...
   (assert (attribute (name best-flavor) (value malty-sweet) (certainty .5)))
   (assert (attribute (name best-flavor) (value hoppy-bitter) (certainty -.5)))
   (assert (attribute (name best-name) (value "English-Style Brown Ale") (certainty .8)))
   (assert (attribute (name best-name) (value "German-Style Hefeweizen") (certainty .8)))
...
(defrule determine-best-beer-attributes-if-which-shellfish-are-mussels
   ...
   =>
   (assert (attribute (name best-name) (value "Belgian-Style Saison") (certainty .9)))
   (assert (attribute (name best-name) (value "Belgian-Style Lambic/Gueuze") (certainty .9))))

(defrule determine-best-beer-attributes-if-which-shellfish-are-oysters
   (declare (salience ?*medium-low-priority*))
   (which-shellfish oysters)
   =>
   (assert (attribute (name best-name) (value "Irish-Style Dry Stout") (certainty .9))))
...
(defrule determine-best-beer-attributes-if-meat-cooking-method-is-braised
   ...
   (assert (attribute (name best-flavor) (value fruity-spicy) (certainty -.5)))
   (assert (attribute (name best-name) (value "German-Style Bock") (certainty .8)))
   (assert (attribute (name best-name) (value "Baltic-Style Porter") (certainty .8))))
...
(defrule determine-best-beer-attributes-if-which-meat-is-rich-meats
   ...
   =>
   (assert (attribute (name best-flavor) (value sour-tart-funky) (certainty .5)))
   (assert (attribute (name best-name) (value "American Brett") (certainty .8)))
   (assert (attribute (name best-name) (value "Belgian-Style Flanders") (certainty .8)))
...
(defrule determine-best-beer-attributes-if-which-rich-is-roasted-beef-or-which-rich-is-lamb
   ...
   (or (and (meat-cooking-method roasted)
       ...
       (which-rich lamb))
   =>
   (assert (attribute (name best-name) (value "English-Style Old Ale") (certainty .9))))

(defrule determine-best-beer-attributes-if-which-beef-is-bresaola
   (declare (salience ?*medium-low-priority*))
   (which-beef bresaola)
   =>
   (assert (attribute (name best-name) (value "American Brown Ale") (certainty .9)))
   (assert (attribute (name best-name) (value "Rye Beer") (certainty .9))))
...
(defrule determine-best-beer-attributes-if-which-rich-is-pork
   ...
   (assert (attribute (name best-flavor) (value malty-sweet) (certainty .5)))
   (assert (attribute (name best-flavor) (value dark-roasty) (certainty -.5)))
   (assert (attribute (name best-name) (value "Imperial IPA") (certainty .9)))
   (assert (attribute (name best-name) (value "Belgian-Style Dubbel") (certainty .9))))
...
(defrule determine-best-beer-attributes-if-which-pork-is-prosciutto
   ...
   =>
   (assert (attribute (name best-name) (value "Bohemian-Style Pilsener") (certainty .9)))
   (assert (attribute (name best-name) (value "German-Style Doppelbock") (certainty .9)))
   (assert (attribute (name best-name) (value "Belgian-Style Saison") (certainty .9))))
...
(defrule determine-best-beer-attributes-if-which-pork-is-speck
   ...
   (which-pork speck)
   =>
   (assert (attribute (name best-name) (value "Smoke Beer") (certainty .9)))
   (assert (attribute (name best-name) (value "American Pale Ale") (certainty .9))))
...
(defrule determine-best-beer-attributes-if-which-pork-is-mortadella
   ...
   =>
   (assert (attribute (name best-name) (value "German-Style Märzen/Oktoberfest") (certainty .9)))
   (assert (attribute (name best-name) (value "Belgian-Style Tripel") (certainty .9))))
...
(defrule determine-best-beer-attributes-if-which-sausage-is-capocollo
   ...
   =>
   (assert (attribute (name best-name) (value "American Amber Lager") (certainty .9)))
   (assert (attribute (name best-name) (value "English-Style Pale Ale (ESB)") (certainty .9))))
...
(defrule determine-best-beer-attributes-if-which-poultry-is-roasted-chicken
   ...
   =>
   (assert (attribute (name best-name) (value "English-Style Bitter") (certainty .9)))
   (assert (attribute (name best-name) (value "English-Style Pale Ale (ESB)") (certainty .9)))
   (assert (attribute (name best-name) (value "German-Style Dunkelweizen") (certainty .9))))
...
(defrule determine-best-beer-attributes-if-which-game-is-wild-or-which-other-vegetables-are-mushrooms
   ...
   (assert (attribute (name best-flavor) (value dark-roasty) (certainty .5)))
   (assert (attribute (name best-name) (value "Irish-Style Dry Stout") (certainty .9)))
   (assert (attribute (name best-name) (value "German-Style Schwarzbier") (certainty .9))))
...
(defrule determine-best-beer-attributes-if-which-game-is-birds
   ...
   (assert (attribute (name best-flavor) (value hoppy-bitter) (certainty .5)))
   (assert (attribute (name best-flavor) (value malty-sweet) (certainty -.5)))
   (assert (attribute (name best-name) (value "American Pale Ale") (certainty .8)))
   (assert (attribute (name best-name) (value "American Brown Ale") (certainty .8)))
...
(defrule determine-best-beer-attributes-if-which-entree-is-fats
   ...
   (assert (attribute (name best-flavor) (value fruity-spicy) (certainty -.5)))
   (assert (attribute (name best-name) (value "American Black Ale") (certainty .8)))
   (assert (attribute (name best-name) (value "English-Style Brown Porter") (certainty .8)))
...
(defrule determine-best-beer-attributes-if-which-fats-is-vegetable
   ...
   =>
   (assert (attribute (name best-carbonation) (value high) (certainty .5)))
   (assert (attribute (name best-carbonation) (value medium) (certainty .2)))
   (assert (attribute (name best-carbonation) (value low) (certainty -.5))))
...
(defrule determine-best-beer-attributes-if-creamy-dessert-is-fruit
   ...
   =>
   (assert (attribute (name best-name) (value "Belgian-Style Fruit Lambic") (certainty .9)))
   (assert (attribute (name best-name) (value "British-Style Barley Wine Ale") (certainty .7)))
   (assert (attribute (name explanation-main-meal) (value (str-cat "That's it because creamy fruit desserts pair "
           "particularly well with a Belgian-Style Fruit Lambic or a British-Style Barley Wine Ale.")))))

(defrule determine-best-beer-attributes-if-which-dessert-is-fruit
   (declare (salience ?*medium-low-priority*))
   (which-dessert fruit)
   =>
   (assert (attribute (name best-flavor) (value fruity-spicy) (certainty .5)))
   ...
   (assert (attribute (name best-name) (value "Belgian-Style Witbier") (certainty .9)))
   (assert (attribute (name best-name) (value "American Wheat") (certainty .9)))
   (assert (attribute (name explanation-specific-meal) (value (str-cat "Moreover, fruit desserts pair well with fruity and spicy beers, "
           "such as wheat ales, witbier and sour beers.")))))

(defrule determine-best-beer-attributes-if-creamy-dessert-is-not-fruit
   (declare (salience ?*medium-low-priority*))
   (creamy-dessert-with-fruit no)
   =>
   (assert (attribute (name best-name) (value "British-Style Barley Wine Ale") (certainty .9)))
   (assert (attribute (name explanation-specific-meal) (value (str-cat "Moreover, creamy desserts pair well with a British-Style Barley "
           "Wine, whose sweetness is heightened on the palate.")))))
...
(defrule determine-best-beer-attributes-if-which-chocolate-is-semisweet
   ...
   (assert (attribute (name best-name) (value "Robust Porter") (certainty .9)))
   (assert (attribute (name best-name) (value "Belgian-Style Dubbel") (certainty .9)))
   (assert (attribute (name best-name) (value "American IPA") (certainty .9))))
...
(defrule determine-best-beer-attributes-if-which-chocolate-is-unsweetened-bitter
   ...
   (assert (attribute (name best-name) (value "Belgian-Style Flanders") (certainty .9)))
   (assert (attribute (name best-name) (value "Belgian-Style Fruit Lambic") (certainty .9)))
   (assert (attribute (name best-name) (value "American Sour") (certainty .9))))