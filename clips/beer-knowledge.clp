...
(defrule determine-best-attributes-if-food-intolerance-is-gluten
...
(defrule determine-best-attributes-if-food-intolerance-is-yeast
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-chocolate-for-omnivorous-or-vegetarian-yeast-intolerant-is-bittersweet
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-chocolate-for-yeast-intolerant-is-unsweetened/bitter
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-preferred-color-is-any
   (declare (salience ?*medium-low-priority*))
   (preferred-color ?color)
   =>
   (assert (attribute (name best-color) (value ?color) (certainty 20))))

(defrule determine-best-attributes-if-preferred-carbonation-is-any
   (declare (salience ?*medium-low-priority*))
   (preferred-carbonation ?carbonation)
   =>
   (assert (attribute (name best-carbonation) (value ?carbonation) (certainty 20))))

(defrule determine-best-attributes-if-smoker-is-yes
   (declare (salience ?*medium-low-priority*))
   (smoker yes)
   =>
...
(defrule determine-best-attributes-if-fermented-foods-eater-is-yes
   (declare (salience ?*medium-low-priority*))
   (fermented-foods-eater yes)
   =>
   (assert (attribute (name best-fermentation) (value wild) (certainty 20))))

(defrule determine-best-attributes-if-preferred-wine-is-Chardonnay
   (declare (salience ?*medium-low-priority*))
   (preferred-wine Chardonnay)
   =>
   (assert (attribute (name best-style) (value "Wheat Beer") (certainty 10))))

(defrule determine-best-attributes-if-preferred-wine-is-Pinot-Noir
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-preferred-wine-is-Pinot-Gris
   (declare (salience ?*medium-low-priority*))
   (preferred-wine "Pinot Gris")
   =>
   (assert (attribute (name best-style) (value "Pilsener & Pale Lager") (certainty 10))))

(defrule determine-best-attributes-if-preferred-wine-is-Sauvignon-Blanc
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-preferred-wine-is-Cabernet-Sauvignon
   (declare (salience ?*medium-low-priority*))
   (preferred-wine "Cabernet Sauvignon")
   =>
   (assert (attribute (name best-style) (value "Stout") (certainty 10))))

(defrule determine-best-attributes-if-preferred-wine-is-Merlot
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-preferred-wine-is-Malbec
   (declare (salience ?*medium-low-priority*))
   (preferred-wine Malbec)
   =>
   (assert (attribute (name best-name) (value "Belgian-Style Dubbel") (certainty 10))))

(defrule determine-best-attributes-if-preferred-wine-is-Zinfandels
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-preferred-wine-is-Syrah
   (declare (salience ?*medium-low-priority*))
   (preferred-wine Syrah)
   =>
   (assert (attribute (name best-style) (value "Porter") (certainty 10))))

(defrule determine-best-attributes-if-preferred-wine-is-Chianti
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-preferred-wine-is-Port
   (declare (salience ?*medium-low-priority*))
   (preferred-wine Port)
   =>
   (assert (attribute (name best-name) (value "Barrel-Aged Beer") (certainty 10))))

(defrule determine-best-attributes-if-preferred-flavor-is-clean
   (declare (salience ?*medium-low-priority*))
   (preferred-flavor clean)
   =>
   (assert (attribute (name best-flavor) (value crisp-clean) (certainty 20))))

(defrule determine-best-attributes-if-preferred-flavor-is-sweet
   (declare (salience ?*medium-low-priority*))
   (preferred-flavor sweet)
   =>
   (assert (attribute (name best-flavor) (value malty-sweet) (certainty 20))))

(defrule determine-best-attributes-if-preferred-aroma-for-sweet-flavor-is-toasty
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-preferred-aroma-for-sweet-flavor-is-caramelly
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-preferred-flavor-is-roasty
   (declare (salience ?*medium-low-priority*))
   (preferred-flavor roasty)
   =>
   (assert (attribute (name best-flavor) (value dark-roasty) (certainty 20))))

(defrule determine-best-attributes-if-preferred-aroma-for-roasty-flavor-is-malty
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-preferred-aroma-for-roasty-flavor-is-dry
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-preferred-flavor-is-bitter
   (declare (salience ?*medium-low-priority*))
   (preferred-flavor bitter)
   =>
   (assert (attribute (name best-flavor) (value hoppy-bitter) (certainty 20))))

(defrule determine-best-attributes-if-preferred-aroma-for-bitter-flavor-is-earthy
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-preferred-aroma-for-bitter-flavor-is-malt-forward
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-preferred-aroma-for-bitter-flavor-is-strong-hop
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-preferred-flavor-is-fruity
   (declare (salience ?*medium-low-priority*))
   (preferred-flavor fruity)
   =>
   (assert (attribute (name best-flavor) (value fruity-spicy) (certainty 20))))

(defrule determine-best-attributes-if-preferred-aroma-for-fruity-or-spicy-flavor-is-brighter
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-preferred-aroma-for-fruity-or-spicy-flavor-is-darker
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-preferred-aroma-for-sour-flavor-is-light
   (declare (salience ?*medium-low-priority*))
   (preferred-aroma-for-sour-flavor light)
   =>
   (assert (attribute (name best-name) (value "Berliner-Style Weisse") (certainty 20))))

(defrule determine-best-attributes-if-preferred-aroma-for-sour-flavor-is-medium
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-preferred-aroma-for-sour-flavor-is-strong
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-main-meal-is-grain
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-main-meal-is-legumes
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-main-meal-is-fats
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-which-fish-is-shellfish
   (declare (salience ?*medium-low-priority*))
   (which-fish shellfish)
   =>
   (assert (attribute (name best-flavor) (value fruity-spicy) (certainty 40))))

(defrule determine-best-attributes-if-which-vegetables-is-root
   (declare (salience ?*medium-low-priority*))
   (which-vegetables root)
   =>
   (assert (attribute (name best-flavor) (value sour-tart-funky) (certainty 70))))

(defrule determine-best-attributes-if-which-vegetables-is-grilled
   (declare (salience ?*medium-low-priority*))
   (which-vegetables grilled)
   =>
   (assert (attribute (name best-flavor) (value dark-roasty) (certainty 70))))

(defrule determine-best-attributes-if-which-meat-is-rich-meats
   (declare (salience ?*medium-low-priority*))
   (which-meat "rich meats")
   =>
   (assert (attribute (name best-flavor) (value sour-tart-funky) (certainty 70))))

(defrule determine-best-attributes-if-which-meat-is-game-birds
   (declare (salience ?*medium-low-priority*))
   (which-meat "game birds")
   =>
   (assert (attribute (name best-flavor) (value hoppy-bitter) (certainty 70))))

(defrule determine-best-attributes-if-which-meat-is-braised-meats
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-which-meat-is-pork
   (declare (salience ?*medium-low-priority*))
   (which-meat pork)
   =>
   (assert (attribute (name best-flavor) (value hoppy-bitter) (certainty 70)))
...
(defrule determine-best-attributes-if-which-pork-is-prosciutto
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-which-pork-is-speck
   (declare (salience ?*medium-low-priority*))
   (which-pork speck)
   =>
...
(defrule determine-best-attributes-if-which-pork-is-mortadella
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-which-sausage-is-capocollo
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-which-sausage-is-soppressata
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-which-sausage-is-salame-piccante
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-which-cheese-is-fresh
   (declare (salience ?*medium-low-priority*))
   (which-cheese fresh)
   =>
...
(defrule determine-best-attributes-if-which-cheese-is-semi-soft
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-which-cheese-is-firm/hard
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-which-cheese-is-blue
   (declare (salience ?*medium-low-priority*))
   (which-cheese blue)
   =>
   (assert (attribute (name best-style) (value "India Pale Ale") (certainty 90))))

(defrule determine-best-attributes-if-which-cheese-is-natural-rind
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-which-cheese-is-washed-rind
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-which-fats-is-vegetable
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-which-chocolate-is-white
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-which-chocolate-is-milk
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-which-chocolate-is-semisweet
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-which-chocolate-is-bittersweet
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-which-chocolate-is-unsweetened/bitter-or-main-meal-vegan-is-chocolate
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-predominant-dish-taste-is-sweet
   (declare (salience ?*medium-low-priority*))
   (predominant-dish-taste sweet)
   =>
   (assert (attribute (name best-flavor) (value dark-roasty) (certainty 60))))

(defrule determine-best-attributes-if-predominant-dish-taste-is-acid
   (declare (salience ?*medium-low-priority*))
   (predominant-dish-taste acid)
   =>
   (assert (attribute (name best-flavor) (value malty-sweet) (certainty 60))))

(defrule determine-best-attributes-if-predominant-dish-taste-is-spice
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-predominant-dish-taste-is-umami
   (declare (salience ?*medium-low-priority*))
...
(defrule determine-best-attributes-if-main-meal-is-fats-and-predominant-dish-taste-is-sweet
   (declare (salience ?*medium-low-priority*))
   (or (main-meal-omnivorous fats)
       (main-meal-vegetarian "vegetable fats")
       (main-meal-vegan "vegetable fats"))
...
(defrule determine-best-attributes-if-dish-cooking-method-is-dry-heat
   (declare (salience ?*medium-low-priority*))
