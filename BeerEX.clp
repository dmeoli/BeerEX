...
(load clips/labels-it.clp)   ; optional Italian overlay (English is the base)

; fuzzy backend (loaded after beerex.clp so its templates/globals exist)
